...
var ReactGoogleAutocomplete = function (_React$Component) {
  ...
  function ReactGoogleAutocomplete(props) {
    ...
    _this.handleLoadScript = function () {
      var googleMapsScriptUrl = "https://maps.googleapis.com/maps/api/js?key=" + _this.props.apiKey;
      var libraryParameters = "libraries=places";
      var hasPlacesLibrary = false;
      document.querySelectorAll("script[src^=\"" + googleMapsScriptUrl + "\"]").forEach(function (scriptTag) {
  ...
  _createClass(ReactGoogleAutocomplete, [{
    ...
    value: function componentDidMount() {
      ...
      var handleAutoComplete = function handleAutoComplete() {
        _this2.autocomplete = new window.google.maps.places.Autocomplete(_this2.refs.input, config);
